...
// There is an inner div from map? No, map returns buttons. So `</div>` closes `<div className="flex gap-1.5">`... wait, let's look at the exact source in WeatherIntel.tsx.
